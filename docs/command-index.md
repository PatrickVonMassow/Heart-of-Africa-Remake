...
343 scripts. Purpose and usage are harvested from the scripts themselves.
...
| `batch-metrics.mjs` | Reconstruct unbiased durable-lane trial metrics from the sealed plan and journal. | usage: node scripts/batch-metrics.mjs --batch <id> [--repo <dir>] [--context <samples.json>] |
