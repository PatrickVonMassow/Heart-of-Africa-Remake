...
| **Chat & Tafel** | H | Chat and board | 440, 451, 465, 467, 473, 539, 491, 508, 520, 621, 625, 664, 665, 699, 704, 705, 706, 713, 720, 728, 730, 731, 740, 749, 777, 793 (793 is the deadlock between the pause and the chat watcher, found 20.08.2026 when the user's two answers sat unread for 19 minutes — it edits the watcher's wake decision, so it is not worked beside anything else that touches the chat path) — the rest landed 30.07.2026 (308, 410, 411, 416, 421, 423, 424, 430, 435, 436, 441, 439, 452, 472, 470) |
