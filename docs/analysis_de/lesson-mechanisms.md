...
| 3.43 | Der Fehler, den die Fail-open-Hülle verschluckt | 3 | LÜCKE: Der Übergabe-Zweig von `scripts/batch-progress-guard.mjs` verbraucht den Marker und stirbt danach am Schreiben der Sperre; die Fail-open-Hülle schluckt den Fehler, der Halt geht durch, übergeben wurde nichts. Arbeitsauftrag 388 dreht die Reihenfolge um, macht das Scheitern in der Freigabe hörbar und isoliert die Testpfade vom Live-Zustand; bis dahin erfasst und ausdrücklich NICHT durchgesetzt. |
