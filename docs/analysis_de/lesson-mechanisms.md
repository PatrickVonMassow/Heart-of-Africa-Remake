...
| 3.49 | Aufräumen, das durch eine Verknüpfung hindurchlöscht | 1 | Arbeitsauftrag 409 — das Löschen eines Arbeitsbaums wird Teil des Mergens und darf KEINER Verknüpfung folgen; ein Stop-Wächter hält den Zug an, solange ein Zweig existiert, dessen Arbeit schon im Hauptzweig liegt. Der Schaden selbst wurde sofort vom Push-Tor gefangen. |
