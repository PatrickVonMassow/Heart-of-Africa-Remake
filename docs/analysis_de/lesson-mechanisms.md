...
| 3.49 | Aufräumen, das durch eine Verknüpfung hindurchlöscht | 3 | LÜCKE: Kein Durchsetzer prüft heute, ob eine Löschoperation einer Verknüpfung folgt. Gefangen hat den Schaden allein `scripts/pre-push-gate.mjs`, unmittelbar danach und zufällig — das ist Schadensbegrenzung, keine Verhinderung. Erfasst als Arbeitsauftrag 409, der das Löschen des Arbeitsbaums in den Merge zieht und ihm verbietet, einer Verknüpfung zu folgen; bis dahin ausdrücklich NICHT durchgesetzt. |
