...
- The ten port cities of §3.1 and the Giza monument site of §4.4 are known from the start: their map-point labels name them from the outset rather than reading "?" until visited (the discovery-gating exemption, §17.2). Ordinary villages stay discovery-gated.
