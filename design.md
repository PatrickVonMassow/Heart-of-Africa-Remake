...
In the bird's-eye view the wet season closes the sight lines (fog pulls in and grays toward overcast), dims the sunlight to an overcast level, and rains visibly — wind-slanted streaks around the traveller. The dry season is the unchanged §19.9 baseline. The zoomed-out debug view stays season-free like it stays haze-free. The land itself follows the season: the ground and the foliage bleach toward straw in the dry season and deepen to green in the rains (only the greenery — rock, sand and trunks stay put, and the deserts, being rainless year round, never leave their neutral look). The wildlife follows it too: in the dry season the animals gather at the remaining water (a wider shore catchment draws them in from farther out), so the shrinking rivers and lakes visibly concentrate life. The first-person settlements follow the season as well: each derives the weather from its OWN coordinates (the bird's-eye weather is not carried in — it would be a stale reading of wherever the traveller last stood), and the rains gray the sky dome, thicken its cloud deck, gray the fog onto the §2.5 backdrop and dim the sun and sky light. The sky is dimmed together with the light on purpose: a dimmed sun under a bright blue sky reads as a bug, not as rain. The §19.10 firelight is a fixed point light and so carries visibly further under the overcast sun. The inhabitants dress for the cold, but only where the record says so: `docs/peoples-1890.md` asked exactly that question and found ONE period source among the game's peoples — Mayr (1907) on the Zulu *isipuku*, an ox-hide cloak "greased and worn by day in cold weather", added over the everyday dress. So a Zulu villager wears it through the austral winter and sheds it in summer, in the mid-transition mix of 1890 (greased black hide, hide with red ochre, and a PLAIN trade blanket — the patterned "Victoria England" design is 1897 and would be an anachronism). Every other people wears the same dress the year round, deliberately: the research reads "Sahel harmattan: EVIDENCE ABSENT — do not invent", the Tuareg seasonal claims are 20th-century tourism copy, the San kaross is tertiary-sourced, no period account of kiremt-season dress exists, and the Basotho blanket belongs to a people the game does not have ("Lesotho is not Zululand"). Coldness therefore never implies a cloak — the Kalahari and the Pedi highveld get cold and stay bare. OPEN: the one reading the research does allow but the figures cannot yet show — that a wrap is worn *differently* in the cold (drawn tight, pulled over head and shoulders) rather than in greater number. Like all of §19 this is ambience and touches no mechanic (whether weather should ever affect movement/health is an OPEN design question, deliberately not invented).
