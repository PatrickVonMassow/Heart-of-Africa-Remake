...
- The season decides the water's mercy (point 122): the rains swell the current (a calibratable factor over the local wetness), the dry season tames it. In calm water an unaided animal eventually clambers out exhausted on its own — in a swollen current the self-rescue never comes: an animal the current carries too long DROWNS (a calibratable window, ~30 s). The river takes the body — it sinks, nothing scavenges it, like the waterfall victims. This holds for any animal, not only calves: a rescuing parent that wades in a swollen current too long drowns beside its calf, and a rescue can genuinely fail — the calf carried past its parent's reach.
