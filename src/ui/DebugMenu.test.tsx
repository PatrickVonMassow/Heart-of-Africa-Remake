...
const EXPECTED_CONTROLS: Record<DebugGroupId, readonly string[]> = {
  ...
  settlement: [
    ...
    'debug.speechHearingFalloff', 'debug.talkReach', 'debug.callReach', 'debug.talkLoudness', 'debug.callLoudness', 'debug.callFalloff', 'debug.speechInstructionHold', 'debug.speechConsequence', 'debug.speechHold', 'debug.speechLabelSeconds', 'debug.speechLabelHeadroom',
