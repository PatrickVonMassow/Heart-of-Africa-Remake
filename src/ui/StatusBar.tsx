...
// gifts, current region. The permanent coordinate display and the "in hand"
// item were removed (design.md §17/§11: item effects follow inventory
// possession); coordinates are read on demand via the position query (P). All
// labels come from the language files.
 ...
 * names the cause and remedy. Rendered inside the status bar (right-aligned) so
