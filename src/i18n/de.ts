  ...
  journal: {
    ...
    villageFirstVisit: (p: TextParams) => {
      ...
      const texts: Record<string, string> = {
        ...
        maasai: `Ich habe das ${name} der Ebenen erreicht. [awe]Hütten aus Geäst und Erde stehen im Ring hinter dem Dornenzaun, und in seiner Mitte das Vieh — Reichtum, Nahrung und Stolz in einem.[/awe] [somber]Die Krieger halten Wache, die langen Speere ruhig, ein Schaffell über der Schulter und von Kopf bis Fuß mit Fett und rotem Ocker eingerieben;[pause] in der Dämmerung sah ich die jungen Männer springen, gerade wie Pfeile, in ihrem Tanz.[/somber]`,
        ...
        sidama: `Ich habe das ${name} im Hochland erreicht. [awe]Rundhäuser mit hohen Strohdächern stehen zwischen Hainen der Ensete — der falschen Banane, die dieses Land ernährt —[pause] und Sträuchern, deren rote Beeren sie rösten, stampfen und zu einem Trank brühen, der Tote wecken könnte.[/awe] [excited]Ich trank drei Tassen.[/excited]`,
