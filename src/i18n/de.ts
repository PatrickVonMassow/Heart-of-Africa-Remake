...
export const de: Strings = {
  ...
  debug: {
    ...
    drumBedGapMax: 'Trommelbett: Phrasenpause max. (s)',
    drumBedTempoSpread: 'Trommelbett: Dorf-Tempostreuung',
    drumBedPitchSpread: 'Trommelbett: Dorf-Tonhöhenstreuung',
    drumBedPitchStart: 'Trommelbett: Anschlagton (Hz)',
    drumBedPitchEnd: 'Trommelbett: Körperton (Hz)',
    drumBedHitSeconds: 'Trommelbett: Schlaglänge (s)',
    drumBedAccentShift: 'Trommelbett: wandernde Akzentstärke',
    drumBedThinAfter: 'Trommelbett: voll ausgedünnt nach (s)',
    drumBedThinFactor: 'Trommelbett: Faktor der ausgedünnten Pause',
    drumBedVillageGain: 'Trommelbett: Lautstärke im Dorf',
    drumBedNearbyGain: 'Trommelbett: Lautstärke in Dorfnähe',
    ...
    talkReach: 'Sprechen: Reichweite',
    callReach: 'Rufen: Reichweite',
    ...
    speechPitch: 'Erwachsene: tiefer Sprachton (Hz)',
    ...
    tagCaughtPause: 'Fangen: Gefangenes Kind steht (s)',
    tagGazeTurn: 'Fangen: Blickwendung des Fängers, Grenze (rad)',
    tagCrySeconds: 'Fangen: Länge des Fangrufs (s)',
    tagCryPitchSpread: 'Fangen: Tonhöhenstreuung des Fangrufs (±)',
    tagCryReach: 'Fangen: Reichweite des Fangrufs (m)',
    ...
    bankTapPause: 'Uferspiel: Pause beim Antippen (s)',
    bankRegroup: 'Uferspiel: Seitenwechsel, Notbremse (s)',
    bankPart: 'Uferspiel: Heimweg dauert (s)',
    bankEndPause: 'Uferspiel: Ende bleibt gehockt (s)',
    bankReach: 'Uferspiel: Felsen berührt ab (m)',
    bankStandOff: 'Uferspiel: Abstand des Warteplatzes (m)',
    bankSpacing: 'Uferspiel: Abstand der Warteplätze (m)',
    ...
    bankRoamGuard: 'Uferspiel: Fels-Nachweis hält den Zyklus höchstens (s)',
  ...
  journal: {
    ...
    drumMessage:
      '[awe]Das Oberhaupt rief seinen Trommler, und zwei Trommeln sprachen an seiner Statt – eine große und eine kleine.[/awe] [pause]Vier Wörter zu je vier Schlägen, jedes vom nächsten durch dieselbe kurze Stille getrennt – dumpf für die tiefe Silbe, hell für die hohe. Die Stimmen in den Gassen und am Wasser können mir helfen, diese Wörter zu deuten. [pause]Ich habe sie in der Reihenfolge notiert, in der sie geschlagen wurden; was sie von mir verlangen, muss ich selbst lesen.',
    rockArtefact:
