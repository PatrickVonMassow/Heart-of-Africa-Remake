...
export const en: Strings = {
  ...
  toasts: {
    ...
    lowDetailsOn: 'Low details on — reduced effects for higher framerate.',
    lowDetailsOff: 'Low details off — full graphics restored.',
  ...
  debug: {
    ...
    shadows: 'Sun shadows',
    lowDetails: 'Low details (performance, F7)',
