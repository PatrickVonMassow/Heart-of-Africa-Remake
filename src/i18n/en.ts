...
export const en: Strings = {
  ...
  toasts: {
    ...
    digInSettlement: 'I do not dig up the ground people live on.',
    formNoFit: 'Nothing here has a hollow that would take this shape.',
    formInSettlement: 'I press it against stone out in the open, not here.',
    rifleReady: 'I shoulder the rifle by myself the moment danger threatens.',
    rifleInSettlement: 'I have no wish to threaten anyone here.',
    ropeReady: 'On a climb the rope comes into use by itself.',
    ropeInUse: 'The rope is already taking my weight.',
    ropeInSettlement: 'There is nothing here to climb.',
    macheteReady: 'The machete swings by itself where the jungle closes in.',
    macheteInUse: 'The machete is already clearing the way.',
    macheteInSettlement: 'I will not swing a blade among people.',
    canoeReady: 'At a river or a lake the canoe is launched by itself.',
    canoeInUse: 'The canoe is already carrying me.',
    canoeInSettlement: 'There is no water here to launch it on.',
  ...
  debug: {
    ...
    drumBedGapMax: 'Drum bed: phrase pause max. (s)',
    drumBedTempoSpread: 'Drum bed: village tempo spread',
    drumBedPitchSpread: 'Drum bed: village pitch spread',
    drumBedPitchStart: 'Drum bed: strike pitch (Hz)',
    drumBedPitchEnd: 'Drum bed: body pitch (Hz)',
    drumBedHitSeconds: 'Drum bed: hit length (s)',
    drumBedAccentShift: 'Drum bed: moving accent strength',
    drumBedThinAfter: 'Drum bed: fully thinned after (s)',
    drumBedThinFactor: 'Drum bed: thinned pause factor',
    drumBedVillageGain: 'Drum bed: village volume',
    drumBedNearbyGain: 'Drum bed: nearby volume',
    ...
    talkReach: 'Talk: reach',
    callReach: 'Call: reach',
    ...
    speechPitch: 'Adults: low speech tone (Hz)',
    ...
    tagCaughtPause: 'Tag: caught child stands (s)',
    tagGazeTurn: 'Tag: chaser gaze turn limit (rad)',
    tagCrySeconds: 'Tag: catch cry length (s)',
    tagCryPitchSpread: 'Tag: catch cry pitch spread (±)',
    tagCryReach: 'Tag: catch cry reach (m)',
    ...
    bankTapPause: 'Bank game: tap pause (s)',
    bankRegroup: 'Bank game: side swap, backstop (s)',
    bankPart: 'Bank game: walk home lasts (s)',
    bankEndPause: 'Bank game: ending stays down (s)',
    bankReach: 'Bank game: a rock counts as touched at (m)',
    bankStandOff: 'Bank game: station stands off a rock (m)',
    bankSpacing: 'Bank game: spacing of the stations (m)',
    ...
    bankRoamGuard: 'Bank game: rock proof holds the cycle at most (s)',
  ...
  journal: {
    ...
    drumMessage:
      '[awe]The chief called his drummer, and two drums spoke for him — a great one and a small one.[/awe] [pause]Four words, each of four beats, each parted from the next by the same short silence — deep for the low syllable, bright for the high one. The voices in the lanes and at the water may help me read these words. [pause]I have written them down in the order they were beaten; what they ask of me I must read for myself.',
    rockArtefact:
