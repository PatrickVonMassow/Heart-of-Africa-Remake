  ...
  journal: {
    ...
    villageFirstVisit: (p: TextParams) => {
      ...
      const texts: Record<string, string> = {
        ...
        maasai: `I have reached the ${name} of the plains. [awe]Huts of branch and earth stand in a ring behind the thorn fence, and at its heart the cattle — wealth, food and pride in one.[/awe] [somber]The warriors keep watch with their long spears at rest, a sheepskin over the shoulder and every inch of them ochred red with fat and clay;[pause] at dusk I saw the young men leap, straight as arrows, in their dance.[/somber]`,
        ...
        sidama: `I have reached the ${name} in the highlands. [awe]Round houses with tall thatched roofs stand among groves of enset — the false banana that feeds this country —[pause] and bushes whose red berries they roast, pound and brew into a drink that would wake the dead.[/awe] [excited]I drank three cups.[/excited]`,
