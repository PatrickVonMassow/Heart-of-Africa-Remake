...
//
// SPLIT BY SUBJECT, NOT SHORTENED (work-order 1178). Every case is still here
// or in a sibling — `layout.fabric`, `layout.waterPath`, `layout.groundWork` —
// and all of them read the same seeds and geometry from `layoutHarness.ts`.
