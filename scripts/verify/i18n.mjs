...
// The permanent coordinate display was removed (design.md §17); coordinates
// are available on demand via the position query (P), tested in gamepad.mjs.
check('no permanent coordinate display', !txt.includes('Latitude') && !txt.includes('Longitude'), '')
...
check('German: no permanent coordinate display', !txt.includes('Grad Nord') && !txt.includes('Grad Ost'), '')
