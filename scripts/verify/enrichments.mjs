...
await shot(
  '130-crocodile-lunge',
  crocLungeRes?.calfAt
    ? { world: { x: crocLungeRes.calfAt.x, z: crocLungeRes.calfAt.z }, label: 'the lunging crocodile at the bank', settle: false }
...
// feeding while the carcass lay at the waterline. Staged like the §19.16 dramas above (the
