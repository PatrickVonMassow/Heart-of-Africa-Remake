...
export const DIAGNOSIS = (missing) =>
  [
    ...
    'The known cause is an agent worktree removed with `git worktree remove` or `rm -rf`:',
    'the worktree carries a junction to the MAIN tree\'s node_modules and the delete follows it.',
    'Repair:  npm install',
