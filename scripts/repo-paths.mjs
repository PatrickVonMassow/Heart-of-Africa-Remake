...
// writes back into the live checkout. An explicit HOA_REPO_ROOT wins, then cwd.
// The module URL is only a last-resort compatibility fallback for an embedding
