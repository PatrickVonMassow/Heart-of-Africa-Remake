...
import { BEAT_MS, DEAD_STATES, LIVE_STATES, MAX_GAP_BEATS, probeAlive, readOutcome, SHAPES, verdict } from './detached-escape-drill.mjs'
...
describe('probeAlive', () => {
  ...
  it('falls back to the signal probe and SAYS that it cannot see a corpse', () => {
