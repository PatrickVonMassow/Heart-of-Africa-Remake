...
export const VERIFICATION_LADDER = [
  ...
  '     0.2-7.4 min, median 2.9 over 16 runs. It runs that block\'s setup and its checks and',
  '     nothing else. The names come from the suite\'s own source: `node',
  '     scripts/verify/run-all.mjs <suite> --section=list` refuses the unknown name and PRINTS',
