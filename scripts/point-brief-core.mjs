...
export const VERIFICATION_LADDER = [
  ...
  '     ON `polish` ALONE: 0.2-7.4 min, median 2.9 over 16 runs; no other suite\'s sections were',
  '     timed, and each is a fraction of ITS OWN pass, so scale from the plan. It runs that',
  ...
  '     9.9-61.5 min, median 55.2 over 6 runs — twenty times the section rung, for the same',
  '     localised finding.',
